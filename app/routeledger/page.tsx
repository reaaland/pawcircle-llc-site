...
export const metadata: Metadata = { title: "RouteLedger" };
  ...
  return (
    <main className="shell page-shell">
      ...
      <div className="detail-grid">
        ...
        <article className="detail-card"><h2>Next direction</h2><p>Client and service rates tied to calendar appointments so RouteLedger can propose expected income before you approve it.</p></article>
